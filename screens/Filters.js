...
export default function Filters({ navigation, route }) {
  ...
  const CheckboxItem = ({ label, isSelected, onPress }) => (
    <TouchableOpacity style={styles.checkboxContainer} onPress={onPress}>
      ...
      />
      <Text
        style={[styles.checkboxLabel, isSelected && styles.checkboxLabelActive]}
      >
        {label}
      </Text>
    </TouchableOpacity>
      ...
      <View style={styles.mainContainer}>
        ...
        >
          ...
          <CheckboxItem
            ...
            onPress={() => toggleCategory("Beverages")}
          />

          <Text style={[styles.sectionTitle, { marginTop: 30 }]}>Brand</Text>
          <CheckboxItem
            label="Individual Collection"
            isSelected={selectedBrand === "Individual Collection"}
            onPress={() => toggleBrand("Individual Collection")}
          />
          <CheckboxItem
            label="Cocola"
            isSelected={selectedBrand === "Cocola"}
            onPress={() => toggleBrand("Cocola")}
          />
          <CheckboxItem
            label="Ifad"
            isSelected={selectedBrand === "Ifad"}
            onPress={() => toggleBrand("Ifad")}
          />
          <CheckboxItem
            label="Coca Cola"
            isSelected={selectedBrand === "Coca Cola"}
            onPress={() => toggleBrand("Coca Cola")}
          />
        </ScrollView>
